...
| A9 | Medium | Imaging-pixel and genomics modalities silently absent (not flagged as deferred). | **[Resolved]** Added to Explicit non-goals in [04-conversational-ai.md](../architecture/04-conversational-ai.md) §6 and roadmap Phase 8. |
...
| A11 | Medium | No third-party integration/marketplace story, and not explicitly scoped out. | **[Resolved]** Added to roadmap as explicit Phase 9+ non-goal. |
| A12 | Medium | No MLOps/fine-tuning/federated-learning roadmap. | **[Resolved]** Added to roadmap Phase 8 as an explicit forward-looking item, not a silent gap. |
